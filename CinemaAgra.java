...
public class CinemaAgra {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CinemaAgra window = new CinemaAgra();
	...
	private void initialize() {
		...
		back.setBounds(43,15,70,40);
		frame.getContentPane().add(back);
		
		JLabel lblNewLabel = new JLabel("CINEMA IN TAJ CITY");
		...
		comboBox.setBounds(1026, 2, 202, 48);
		panel.add(comboBox);
