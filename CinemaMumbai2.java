...
public class CinemaMumbai2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CinemaMumbai2 window = new CinemaMumbai2();
	...
	private void initialize() {
		...
		cinemaHall.setModel(new DefaultComboBoxModel(new String[] {"MovieMax-Sion", "PVR Icon Infiniti", "Metro Inox Cinema", "Carnival Cinema", "PVR City mall", "Premiere Gold Theatre", "Sterling Cineplex", "Regal Cinema"}));
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							textArea.print();
							frame.dispose();
							CinemaMumbai2 obj =new CinemaMumbai2();
							obj.main(null);						}
						catch(Exception ex) {
							ex.printStackTrace();
