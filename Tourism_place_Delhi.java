...
public class Tourism_place_Delhi {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tourism_place_Delhi window = new Tourism_place_Delhi();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("TOURISM PLACES IN DELHI");
		...
		JLabel lblNewLabel_1 = new JLabel("DELHI IS THE CAPITAL OF INDIA ");
		...
		lblNewLabel_2.setIcon(new ImageIcon("D:\\Project _Image\\d11 (1).jpg"));
		lblNewLabel_2.setBounds(0, 0, 300, 216);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("<html><body><p> Delhi: Old and New Delhi City Private Guided Day Trip\r\n</p></body></html>");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3.setBounds(7, 216, 292, 34);
		panel_1.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("Rate - ₹ 1,250.00   per adult");
		...
		lblNewLabel_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.getyourguide.com/new-delhi-l231/new-delhi-full-day-old-new-monuments-private-tour-t98637/?ranking_uuid=87239ff0-756b-4790-8be8-da21db972f94"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		lblNewLabel_2_1.setIcon(new ImageIcon("D:\\Project _Image\\d5.jpg"));
		lblNewLabel_2_1.setBounds(2, 0, 300, 172);
		panel_1_1.add(lblNewLabel_2_1);
		
		JLabel lblNewLabel_3_1 = new JLabel("<html><body><p>\r\nPurana Quila Entry Ticket, Delhi</p></body></html>");
		...
		lblNewLabel_5_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/purana-quila-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		lblNewLabel_5_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/humayuns-tomb-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		lblNewLabel_5_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/jantar-mantar-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		lblNewLabel_5_1_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/firoz-shah-kotla-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		JLabel lblNewLabel_4_1_1 = new JLabel("from ₹30.00 per adult");
		...
		lblNewLabel_5_2_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/qutab-minar-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		JLabel lblNewLabel_4_1_2 = new JLabel("from ₹35.00 per adult ");
		...
		lblNewLabel_5_2_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/red-fort-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
...
//				lblNewLabel_5.setForeground(new Color(255,255,255));
		...
		lblNewLabel_2_1_3.setIcon(new ImageIcon("D:\\Project _Image\\d8.jpg"));
		...
		JLabel lblNewLabel_4_1_3 = new JLabel("from ₹25.00 per adult ");
		...
		lblNewLabel_5_2_1_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					String str[] =new String[] {"C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe" , "https://www.thrillophilia.com/tours/safdarjungs-tomb-entry-ticket-delhi"};
					r.exec(str);
				}catch(Exception e1) {
					e1.printStackTrace();
