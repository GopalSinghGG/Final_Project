...
public class CinemaBangluru1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CinemaBangluru1 window = new CinemaBangluru1();
	...
	private void initialize() {
		...
		cinemaHall.setModel(new DefaultComboBoxModel(new String[] {"Meher Theatre", "Gold Cinema", "Sarv Multiplex", "Vimal Cineplex", "Bharat Starworld", "Shree Talkies", "Sanjay Talkies", "Mahalaxmi Cinema"}));
		...
		txtrAGoodMovie.setBounds(127, 347, 703, 310);
