...
public class Cinemalucknow2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Cinemalucknow2 window = new Cinemalucknow2();
	...
	private void initialize() {
		...
		cinemaHall.setFont(new Font("Segoe Print", Font.BOLD, 17));
		cinemaHall.setModel(new DefaultComboBoxModel(new String[] {"Inox Riverside Mall", "Inox Umrao Mall", "Wave Cinemas", "Shubham Cinema", "PVR Phoenix", "Pratibha Theatre", "SRS Cinemas", "Anand Theatre"}));
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							con=DriverManager.getConnection("jdbc:mysql://localhost:33306/minor_project","root","");
							pr=con.prepareStatement("insert into cinema_ticket(movie_name,cinema_hall,ticket,seat_no,time,total_amount) values(?,?,?,?,?,?)");
							pr.setString(1, movie.getText());
							...
							textArea.print();
							frame.dispose();
							Cinemalucknow2 obj =new Cinemalucknow2();
							obj.main(null);						}
						catch(Exception ex) {
							ex.printStackTrace();
		...
		cancle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				CinemaLucknow obj =new CinemaLucknow();
				obj.main(null);
			}
		});
		...
		lblNewLabel_4.setBackground(new Color(165, 42, 42));
		...
		txtrAGoodMovie.setForeground(new Color(0, 255, 255));
		...
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\GOPAL SINGH\\Documents\\Images\\bk.jpg"));
		lblNewLabel_6.setBounds(0, 0, 1348, 723);
